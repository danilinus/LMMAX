...
public class BaseAddress implements Serializable {
    ...
    public BaseAddress () { addressList = new ArrayList<>(); }

    public void add (AddressCast addressCast) { addressList.add(addressCast); }

    public void add (String name) { addressList.add(new AddressCast(name)); }

    public AddressCast get (int i) { return addressList.get(i); }

    public void remove (int i) { addressList.remove(i); }
